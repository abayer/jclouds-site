...
To get an optional dependency go to the [Installation Guide]({{ site.url }}/documentation/userguide/installation-guide/index.html) and include the dependency for your kind of installation. For example, in the Getting the latest binaries section add [org.jclouds/jclouds-log4j "X.X.X"] to the list of dependencies.
