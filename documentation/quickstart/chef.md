...
3. Setup your project to include `chef`, `hostedchef` or `privatechef`, depending on the Chef flavor you are going to connect to.
    * Get the dependencies `org.jclouds.api/chef` using jclouds [Installation]({{ site.url }}/documentation/userguide/installation-guide/index.html).
    * Get the dependencies `org.jclouds.labs/hostedchef` using jclouds [Installation]({{ site.url }}/documentation/userguide/installation-guide/index.html).
    * Get the dependencies `org.jclouds.labs/privatechef` using jclouds [Installation]({{ site.url }}/documentation/userguide/installation-guide/index.html).
4. Start coding
