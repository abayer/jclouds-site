...
We use the same model across the [ComputeGuide]({{ site.url }}/documentation/userguide/compute/index.html) which allows you to facilitate collocation of processing and data.
...
See [Blobstore API: Supported Providers]({{ site.url }}/documentation/reference/supported-providers#blobstore/index.html) for providers that can be used equally in any Blobstore API tool.
