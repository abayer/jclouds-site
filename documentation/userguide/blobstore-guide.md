...
We use the same model across the [ComputeGuide]({{ site.url }}/documentation/userguide/compute) which allows you to facilitate collocation of processing and data.
...
See [Blobstore API: Supported Providers]({{ site.url }}/documentation/reference/supported-providers#blobstore) for providers that can be used equally in any Blobstore API tool.
