...
We've improved our development process to include simulating api server responses.  Check out our [provider testing]({{ site.url }}/documentation/devguides/provider-testing/index.html) page for more.
...
|---------------------|----------------|-------------------|-----------|----------|
| o.j.p/aws-cloudwatch| | US-VA,US-CA,US-OR,BR-SP,IE,SG| [1/1]({{ site.url }}/documentation/releasenotes/1.3.0-output/aws-cloudwatch.txt/index.html)| |
| o.j.p/aws-ec2| compute| US-VA,US-CA,US-OR,BR-SP,IE,SG| [153/153]({{ site.url }}/documentation/releasenotes/1.3.0-output/aws-ec2.txt/index.html)| |
| o.j.p/aws-s3| blobstore| US,US-CA,US-OR,BR-SP,IE,SG| [103/103]({{ site.url }}/documentation/releasenotes/1.3.0-output/aws-s3.txt/index.html)| |
| o.j.p/azureblob| blobstore| US-TX,US-IL,IE-D,SG,NL-NH,HK| [94/95]({{ site.url }}/documentation/releasenotes/1.3.0-output/azureblob.txt/index.html)| [failures]({{ site.url }}/documentation/releasenotes/1.3.0-output/azureblob-failures.txt)|
| o.j.p/bluelock-vcloud-zone01| compute| US-IN| [123/123]({{ site.url }}/documentation/releasenotes/1.3.0-output/bluelock-vcloud-zone01.txt/index.html)| |
| o.j.p/cloudfiles-uk| blobstore| GB-SLG| [88/88]({{ site.url }}/documentation/releasenotes/1.3.0-output/cloudfiles-uk.txt/index.html)| |
| o.j.p/cloudfiles-us| blobstore| US-TX| [89/90]({{ site.url }}/documentation/releasenotes/1.3.0-output/cloudfiles-us.txt/index.html)| [failures]({{ site.url }}/documentation/releasenotes/1.3.0-output/cloudfiles-us-failures.txt)|
| o.j.p/cloudloadbalancers-uk| loadbalancer| GB-SLG| [8/8]({{ site.url }}/documentation/releasenotes/1.3.0-output/cloudloadbalancers-uk.txt/index.html)| |
| o.j.p/cloudloadbalancers-us| loadbalancer| US-IL,US-TX| [8/8]({{ site.url }}/documentation/releasenotes/1.3.0-output/cloudloadbalancers-us.txt/index.html)| |
| o.j.p/cloudonestorage| blobstore| US-GA,US-TX| [63/71]({{ site.url }}/documentation/releasenotes/1.3.0-output/cloudonestorage.txt/index.html)| [failures]({{ site.url }}/documentation/releasenotes/1.3.0-output/cloudonestorage-failures.txt)|
| o.j.p/cloudservers-uk| compute| GB-SLG| [151/152]({{ site.url }}/documentation/releasenotes/1.3.0-output/cloudservers-uk.txt/index.html)| [failures]({{ site.url }}/documentation/releasenotes/1.3.0-output/cloudservers-uk-failures.txt)|
| o.j.p/cloudservers-us| compute| US-IL,US-TX| [151/151]({{ site.url }}/documentation/releasenotes/1.3.0-output/cloudservers-us.txt/index.html)| |
| o.j.p/cloudsigma-zrh| compute| CH-ZH| [139/149]({{ site.url }}/documentation/releasenotes/1.3.0-output/cloudsigma-zrh.txt/index.html)| [failures]({{ site.url }}/documentation/releasenotes/1.3.0-output/cloudsigma-zrh-failures.txt)|
| o.j.p/cloudsigma-lvs| compute| US-NV| [138/146]({{ site.url }}/documentation/releasenotes/1.3.0-output/cloudsigma-lvs.txt/index.html)| [failures]({{ site.url }}/documentation/releasenotes/1.3.0-output/cloudsigma-lvs-failures.txt)|
| o.j.p/elastichosts-lax-p| compute| US-CA| [129/129]({{ site.url }}/documentation/releasenotes/1.3.0-output/elastichosts-lax-p.txt/index.html)| |
| o.j.p/elastichosts-lon-b| compute| GB-LND| [129/129]({{ site.url }}/documentation/releasenotes/1.3.0-output/elastichosts-lon-b.txt/index.html)| |
| o.j.p/elastichosts-lon-p| compute| GB-LND| [129/129]({{ site.url }}/documentation/releasenotes/1.3.0-output/elastichosts-lon-p.txt/index.html)| |
| o.j.p/elastichosts-sat-p| compute| US-TX| [129/129]({{ site.url }}/documentation/releasenotes/1.3.0-output/elastichosts-sat-p.txt/index.html)| |
| o.j.p/elastichosts-tor-p| compute| CA-OR| [129/129]({{ site.url }}/documentation/releasenotes/1.3.0-output/elastichosts-tor-p.txt/index.html)| |
