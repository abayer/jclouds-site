...
See [EC2 Image Filters]({{ site.url }}/documentation/reference/using-ec2) for more.
...
This doesn't impact use of [ComputeService]({{ site.url }}/documentation/userguide/compute), but it does impact the provider-specific terremark apis, 
...
Many jclouds [ComputeService]({{ site.url }}/documentation/userguide/compute) users install middleware via our `runScript` functionality directly 
